...
type QmlBridge struct {
	core.QObject
	_ func(blockNumber uint64,networkId string,peers uint64, gasPrice uint64,sync string,hashrate uint64) `signal:"load"`
}
...
func main() {
	...
	// go func() {
	// 	for{
	// 		blockNumber,networkId,peers,gasPrice,syncStatus,hashrate := load.Start()
	// 		qmlBridge.Load(blockNumber,networkId,peers,gasPrice,syncStatus,hashrate)
	// 	}
